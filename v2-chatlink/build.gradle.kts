    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                implementation("com.github.Woody230.KotlinExtensions:function:$extensionVersion")
                implementation("com.github.Woody230.KotlinExtensions:base64:$extensionVersion")
            }
        }
