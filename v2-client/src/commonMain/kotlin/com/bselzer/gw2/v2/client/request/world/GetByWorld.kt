...
interface GetByWorld<Model> {
    /**
     * Gets the [Model] associated with the world that has id [worldId], or a [Gw2ClientException] if unable to fulfill the request.
     */
    suspend fun byWorld(worldId: WorldId, options: Gw2HttpOptions): Result<Model>
