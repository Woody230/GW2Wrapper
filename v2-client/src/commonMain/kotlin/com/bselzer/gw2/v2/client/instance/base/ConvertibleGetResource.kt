...
abstract class ConvertibleGetResource<ResponseModel, ResultModel>(
     ...
     *
     * If the response is successful, then the response body is converted into the [ResponseModel] and then into [ResultModel] by [convert] and the [Gw2Options.onGetSuccess] is applied.
