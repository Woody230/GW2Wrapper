...
data class Profession(
     ...
     */
    @SerialName("weapons")
    val weapons: Map<com.bselzer.gw2.v2.model.wrapper.WeaponType, ProfessionWeapon> = emptyMap(),

    @SerialName("flags")
    val flags: List<com.bselzer.gw2.v2.model.wrapper.ProfessionFlag> = emptyList(),
